...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row shadow-sm p-3 bg-white rounded d-flex align-items-center">
			...
			<div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 col-4 order-1">
				<span class="d-xl-none d-lg-none d-md-inline d-sm-inline d-inline  p-1 navslidemenu btn-success">
					<i class="icofont-navigation-menu"></i>
				</span>
				<a href="index.php">
					<img src="logo/shop.jpg" class="ml-4 img-fluid d-xl-inline d-lg-inline d-md-none d-sm-none d-none" style="width: 150px;height: 60px;">
				</a>

				<a href="index.php">
					<img src="logo/shop.jpg" class="img-fluid d-xl-none d-lg-none d-md-inline d-sm-none d-none" style="width: 100px">
				</a>

				<a href="index.php">
					<img src="logo/shop.jpg" class="img-fluid d-xl-none d-lg-none d-md-none d-sm-inline d-inline pl-2 text-success" style="width: 30px">
				</a>
			</div>
			...
			<div class="col-xl-6 col-lg-6 col-md-4 col-sm-2 col-2 order-xl-2 order-lg-2 order-md-3 order-sm-3 order-3">
				<div class="row">
					...
					<div class="col-lg-4 col-10">
						...
						<a href="javascript:void(0)" class="d-xl-block d-lg-block d-md-block d-none  text-decoration-none loginLink float-right text-success" data-toggle="dropdown" role="button"> 
						...
						<?php } else{ ?>
							...
							<a href="login.php" class="d-xl-block d-lg-block d-md-block d-none  text-decoration-none  text-success loginLink float-right"> Login | Sign-up </a>
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 order-xl-3 order-lg-3 order-md-4 order-sm-4 order-4 text-right">
				...
				<a href="cart.php" class="text-decoration-none d-xl-inline d-lg-inline d-md-inline d-sm-none d-none shoppingcartLink"> 
					<i class="icofont-shopping-cart text-success"></i> 
					<span class="badge badge-pill badge-light badge-notify cartNotistyle cartNoti bg-success"> </span>
					<span class="cartTotal text-success"> </span>
				</a>
				...
				<img src="logo/shop.jpg" class="d-xl-inline d-lg-inline d-md-none d-sm-none d-none" style="width: 120px;height: 45px;">
			</div>
		</div>
	</div>
	<div id="myPage"></div>
	...
	<div id="mySidebar" class="sidebar">
		<div class="row">
			<div class="col-10">
	  			<img src="logo/shop.jpg" class="img-fluid ml-2 text-center" style="width: 250px">
			</div>
			<div class="col-2">
		...
		<div class="mt-3">
			...
			<p class="text-light text-center" style="opacity: 0.6"> Copyright &copy; 2020</p>
