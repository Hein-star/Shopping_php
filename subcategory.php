			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
				<ul class="list-group">
					...
					?>
				  	...
				  	<li class="list-group-item btn-success<?php if($subid == $sid) echo "" ?>">
				  		<a href="subcategory.php?id=<?= $subid ?>" class="text-decoration-none"> <?= $subname ?> </a>
				  	</li>
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
							<div class="card pad15 mb-3">
							  	...
							  	<div class="card-body text-center">
									...
									<a href="cart.php" class="addtocartBtn text-decoration-none btn-outline-success" data-id="<?= $itid ?>"
				...
				<nav aria-label="Page navigation example">
					<ul class="pagination justify-content-end">
					    <li class="page-item disabled">
					      	<a class="page-link text-success" href="#" tabindex="-1" aria-disabled="true"><i class="icofont-rounded-left"></i>
					      	</a>
					    </li>
					    <li class="page-item">
