...
?>
	...
	<div class="container mt-5">
		...
		<div class="row mt-5 shoppingcart_div">
			<div class="col-12">
				<a href="index.php" class="btn btn-success float-right px-3" > 
					...
					<tfoot id="shoppingcart_tfoot">
						...
						<tr> 
							...
							<td colspan="3">
								...
								<button class="btn btn-success btn-block checkoutbtn"> 
									Check Out 
								</button>
								<?php }else{ 
									$_SESSION['cartURL'] = 'cart.php';
								?>
									<a href="login.php" class="btn btn-success btn-block"> Check Out </a>
								<?php } ?>
							</td>
						</tr>
					</tfoot>
		...
		<div class="row mt-5 noneshoppingcart_div text-center">
			...
			<div class="col-12 mt-5 ">
				<a href="index.php" class="btn btn-success px-3" > 
					<i class="icofont-shopping-cart"></i>
					Continue Shopping 
				</a>
			</div>
